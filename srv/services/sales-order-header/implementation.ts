...
import { CreationValidationResult, SalesOrderHeaderService } from '@/services/sales-order-header/protocols';
...
export class SalesOrderHeaderServiceImpl implements SalesOrderHeaderService {
    ...
    private async getproductsByIds(
        ...
        const productsId = params.items?.map((item) => item.product_id) as string[];
